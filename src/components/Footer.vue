<template>
  <footer class="bg-autocare-blue px-5 py-5 xl:px-10">
    <div class="flex flex-wrap text-white sm:px-8 sm:py-8 lg:px-16 xl:px-32">
      <div class="w-1/3 sm:w-1/4 mt-6 px-2">
        ...
        <div class="text-xs font-segoe-light mt-3">
          ...
          <a class="block h-8 leading-tight">Terms & Conditions</a>
        </div>
      </div>
      <div class="w-1/3 sm:w-1/4 mt-6 px-2">
      ...
      <div class="w-auto sm:w-1/4 mt-10 sm:mt-6 px-2">
        ...
        <div class="text-xs font-segoe-light mt-3">
          ...
          <div class="flex justify-between w-4/5 lg:w-3/4 xl:w-2/4">
            ...
            /></a>
            <a href="#"
              ><img src="../assets/img/linkedin.svg" alt="linkedin" class="h-4"
            /></a>
            <a href="#"
              ><img src="../assets/img/twitter.svg" alt="twitter" class="h-4"
            /></a>
            <a href="#"
              ><img src="../assets/img/whatsapp.svg" alt="whatsapp" class="h-4"
            /></a>
          </div>
        </div>
      </div>
    ...
    <div
      class="border-b border-1 border-autocare-orange w-full mx-auto sm:mx-0 mt-6"
    ></div>
    <div class="mt-2 sm:flex sm:items-center sm:justify-between sm:mt-4">
      <img
